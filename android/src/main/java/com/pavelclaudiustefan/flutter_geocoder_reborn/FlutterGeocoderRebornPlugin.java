 ...
 */
public class FlutterGeocoderRebornPlugin implements MethodCallHandler {

  private Geocoder geocoder;

  public FlutterGeocoderRebornPlugin(Context context) {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_geocoder_reborn");
    channel.setMethodCallHandler(new FlutterGeocoderRebornPlugin(registrar.context()));
  }
  ...
  private void findAddressesFromQuery(final String address, final Result result) {
    ...
    final FlutterGeocoderRebornPlugin plugin = this;
